...
Reference full template: `/home/thomas/atos/simpleEAM/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/thomas/atos/simpleEAM/.claude/gsd-core/templates/state.md`.
