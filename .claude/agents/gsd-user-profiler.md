...
<reference>
@/home/thomas/atos/simpleEAM/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/thomas/atos/simpleEAM/.claude/gsd-core/references/user-profiling.md` to load:
