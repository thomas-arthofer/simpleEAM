...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/thomas/atos/simpleEAM/.claude/.gsd-surface.json`
(sibling to `/home/thomas/atos/simpleEAM/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/thomas/atos/simpleEAM/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/thomas/atos/simpleEAM/.claude/skills`).
...
`/home/thomas/atos/simpleEAM/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/thomas/atos/simpleEAM/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/thomas/atos/simpleEAM/.claude/.gsd-surface.json`
Install profile marker: `/home/thomas/atos/simpleEAM/.claude/.gsd-profile`
Skill dirs: `/home/thomas/atos/simpleEAM/.claude/skills/gsd-*/`
Engine module: `/home/thomas/atos/simpleEAM/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/thomas/atos/simpleEAM/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
