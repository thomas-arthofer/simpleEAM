...
<!-- For checkpoint task examples and patterns, see @/home/thomas/atos/simpleEAM/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/thomas/atos/simpleEAM/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/thomas/atos/simpleEAM/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/thomas/atos/simpleEAM/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
