...
```markdown
Read /home/thomas/atos/simpleEAM/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/thomas/atos/simpleEAM/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/thomas/atos/simpleEAM/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/thomas/atos/simpleEAM/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/thomas/atos/simpleEAM/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/thomas/atos/simpleEAM/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/thomas/atos/simpleEAM/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
