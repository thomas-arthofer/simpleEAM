...
ones). Reference: @/home/thomas/atos/simpleEAM/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/thomas/atos/simpleEAM/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/thomas/atos/simpleEAM/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/thomas/atos/simpleEAM/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/thomas/atos/simpleEAM/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/thomas/atos/simpleEAM/.claude/gsd-core/templates/spec.md.
