...
```
Agent(
  prompt="Read /home/thomas/atos/simpleEAM/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/thomas/atos/simpleEAM/.claude/gsd-core/templates/SECURITY.md`
