...
INSTALL_JS_GLOBAL="/home/thomas/atos/simpleEAM/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/thomas/atos/simpleEAM/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
