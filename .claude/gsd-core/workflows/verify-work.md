...
<template>
@/home/thomas/atos/simpleEAM/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/thomas/atos/simpleEAM/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/thomas/atos/simpleEAM/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/thomas/atos/simpleEAM/.claude/gsd-core/workflows/diagnose-issues.md
