...
- [x] **SUX-01**: When a user opens an element view, the UI shows whether that element's sovereignty rating satisfies the relevant higher-level requirements.
- [x] **SUX-02**: When sovereignty issues exist, the element view distinguishes whether the current element is the cause of the issue or is affected by an issue lower in the chain.
